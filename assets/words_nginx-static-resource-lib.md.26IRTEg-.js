import{_ as s,o as n,c as a,R as l}from"./chunks/framework.uaFRvtsY.js";const d=JSON.parse('{"title":"一个基于Nginx的静态资源库","description":"","frontmatter":{"title":"一个基于Nginx的静态资源库"},"headers":[],"relativePath":"words/nginx-static-resource-lib.md","filePath":"words/nginx-static-resource-lib.md"}'),p={name:"words/nginx-static-resource-lib.md"},o=l(`<div class="tip custom-block"><p class="custom-block-title">时间</p><p>2018-04-14 17:58:36</p></div><p><a href="https://baike.baidu.com/item/nginx/3817705" target="_blank" rel="noreferrer">Nginx</a>是一个高性能的HTTP和反向代理服务器，也是一个IMAP/POP3/SMTP服务器。在学习Nginx的过程中，开发了一个简单的静态资源库<a href="https://github.com/ourvibes/BirdNest" target="_blank" rel="noreferrer">BirdNest</a>。😃</p><p>核心代码</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
