import{_ as s,c as i,o as a,a2 as n}from"./chunks/framework.CVjco_zO.js";const F=JSON.parse('{"title":"Vue项目开发实践","description":"","frontmatter":{"title":"Vue项目开发实践"},"headers":[],"relativePath":"flow/vue-dev.md","filePath":"flow/vue-dev.md"}'),p={name:"flow/vue-dev.md"},l=n(`<p>Vue+ElementUI项目开发实践。😃</p><ul><li><a href="https://www.npmjs.com/package/axios" target="_blank" rel="noreferrer">Axios</a></li><li><a href="https://router.vuejs.org/zh/" target="_blank" rel="noreferrer">VueRouter</a></li><li>KeepAlive</li><li><a href="https://www.lodashjs.com/" target="_blank" rel="noreferrer">Lodash</a></li></ul><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"></span>
