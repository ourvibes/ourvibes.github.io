import{_ as s,c as i,o as a,a3 as n}from"./chunks/framework.LNmJnetQ.js";const c=JSON.parse('{"title":"Vue项目开发实践","description":"","frontmatter":{"title":"Vue项目开发实践"},"headers":[],"relativePath":"flow/vue-dev.md","filePath":"flow/vue-dev.md"}'),p={name:"flow/vue-dev.md"},l=n(`<p>Vue+ElementUI项目开发实践。😃</p><ul><li><a href="https://www.npmjs.com/package/axios" target="_blank" rel="noreferrer">Axios</a></li><li><a href="https://router.vuejs.org/zh/" target="_blank" rel="noreferrer">VueRouter</a></li><li>KeepAlive</li><li><a href="https://www.lodashjs.com/" target="_blank" rel="noreferrer">Lodash</a></li></ul><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    }</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div>`,11),h=[l];function t(k,e,E,r,d,g){return a(),i("div",null,h)}const F=s(p,[["render",t]]);export{c as __pageData,F as default};
