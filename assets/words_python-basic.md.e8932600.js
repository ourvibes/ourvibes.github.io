import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.52d8a8a6.js";const B=JSON.parse('{"title":"Python语言基础","description":"","frontmatter":{"title":"Python语言基础"},"headers":[],"relativePath":"words/python-basic.md","filePath":"words/python-basic.md"}'),p={name:"words/python-basic.md"},o=l(`<div class="tip custom-block"><p class="custom-block-title">时间</p><p>2017-10-18 19:18:47</p></div><p>Python是我目前见过的语言中最简洁优雅的，以至于我有一种相见恨晚的感觉。下面是一些笔记（代码）。😃</p><div class="language-python vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">python</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
